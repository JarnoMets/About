...
`;
  ...
  function frame() {
    ...
    const idleSince = (nowMs - sharedRotation.lastMoveMs) / 1000; // seconds since last move
    ...
    sharedRotation.autoSpinT += dt * backgroundFilter.speed * idleWeight;
